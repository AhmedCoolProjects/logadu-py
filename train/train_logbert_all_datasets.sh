...
# mkdir -p ./trained_models/logbert
# mkdir -p ./logs-train/logbert
# mkdir -p ./logs-train/logbert/fox
# mkdir -p ./logs-train/logbert/linux24
# mkdir -p ./logs-train/logbert/russellmitchell
# mkdir -p ./logs-train/logbert/win25ch
...
echo "Starting LogBERT training for all datasets and window sizes..."
echo "=========================================="
...
for dataset_name in "${!datasets[@]}"; do
    ...
    echo ""
    echo "============================================"
    echo "Training LogBERT on ${dataset_name^^} dataset..."
    echo "============================================"
    ...
    for window_size in "${window_sizes[@]}"; do
        ...
        log_file="./logs-train/logbert/${dataset_name}/logbert_${dataset_name}_train_${window_size}.log"
        
        # Construct W&B run name and dataset name
        wandb_run_name="logbert_${dataset_name}_index_${window_size}"
        ...
        run_and_log "$log_file" \
            ...
            --model logbert \
            --epochs 100 \
            --output-dir ./trained_models/logbert \
...
echo ""
echo "=========================================="
echo "🎉 All LogBERT training jobs completed!"
echo "=========================================="
echo ""
...
echo "  - Models: ./trained_models/logbert/"
echo "  - Logs: ./logs-train/logbert/{dataset_name}/"
echo "=========================================="