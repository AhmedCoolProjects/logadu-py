...
mkdir -p ./logs-predict/logbert
mkdir -p ./logs-predict/logbert/fox
mkdir -p ./logs-predict/logbert/linux24
mkdir -p ./logs-predict/logbert/russellmitchell
mkdir -p ./logs-predict/logbert/win25ch
...
MODEL_BASE_PATH="/home/ahmed.bargady/lustre/nlp_team-um6p-st-sccs-id7fz1zvotk/IDS/ahmed.bargady/data/github/logs-ad-ultimate/logadu-package/trained_models/logbert"

echo "Starting LogBERT prediction for all datasets and window sizes..."
echo "=========================================="
...
for dataset_name in "${!datasets[@]}"; do
    ...
    echo ""
    echo "============================================"
    echo "Running LogBERT predictions on ${dataset_name^^} dataset..."
    echo "============================================"
    ...
    for window_size in "${window_sizes[@]}"; do
        ...
        model_checkpoint="${MODEL_BASE_PATH}/logbert-${dataset_name}_${window_size}-best-checkpoint.ckpt"
        
        # Construct log file path
        log_file="./logs-predict/logbert/${dataset_name}/logbert_${dataset_name}_predict_${window_size}.log"
...
echo ""
echo "=========================================="
echo "🎉 All LogBERT prediction jobs completed!"
echo "=========================================="
echo ""
...
echo "  - Anomaly threshold: 2"
echo ""
echo "📁 Check the following directories:"
echo "  - Prediction logs: ./logs-predict/logbert/{dataset_name}/"
