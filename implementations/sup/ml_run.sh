...
models=( "pca" ) # The only change is here: targeting only the pca model
...
LOG_DIR="/home/ahmed.bargady/lustre/nlp_team-um6p-st-sccs-id7fz1zvotk/IDS/ahmed.bargady/data/github/logs-ad-ultimate/logadu-package/implementations/unsup/logs3"
mkdir -p "$LOG_DIR"
TS=$(date +%Y%m%d_%H%M%S)
# Creating a specific folder for this run
FOLDER_="$LOG_DIR/ocsvm_run_${TS}"
mkdir -p "$FOLDER_"
