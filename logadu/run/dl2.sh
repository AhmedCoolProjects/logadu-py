...
# DeepLog: bash scripts/run_logadu_grid.sh <model> <paradigm> <PATH_DIR>
...
DATASETS=(
"fox" "santos" "harrison" "russellmitchell" known_c1 known_c2 known_c3 known_c4 known_c5 known_c6 known_c7 known_c8
)
